...
<html>
  ...
  <body>
    ...
    <br>
    Prenom du stagiaire <input id="prenomStagiaire" type="text" name="prenomStagiaire" value="prenom"><br>
    Nom du stagiaire <input id="nomStagiaire" type="text" name="nomStagiaire" value="nom"><br>
    Courriel scholaire <input id="courrielStagiaire" type="text" name="courrielStagiaire" value="nom.prenom@etu.cegepjonquiere.ca"><br>
