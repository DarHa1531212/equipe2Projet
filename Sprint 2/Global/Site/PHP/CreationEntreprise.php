...
<html>
  ...
  <body>
    ...
    <br>
    Nom entreprise <input id="nomEntreprise" class = "data" type="text" name="prenomStagiaire" value="nom entreprise"><br>
    Adresse entreprise <input id="adresseEntreprise" class = "data" type="text" name="nomStagiaire" value="adresse entreprise"><br>
    No téléphone entreprise <input id="noTelEntreprise" class = "data" type="text" name="nomStagiaire" value="numero téléphone"><br>
    ...
    <input type="submit" id="Save" class="bouton" value="Sauvegarder" onclick="Execute(5, '../PHP/TBNavigation.php?nomMenu=CRUDEntreprise')" />
    <br>
