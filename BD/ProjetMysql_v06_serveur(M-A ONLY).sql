...
SELECT EcheancierTachesAVenir,AppreciationTravail,IntegrationMilieuStage,InteractionAvecAutres,FaconDeFaire,Statut,DateComplétée
...
CREATE VIEW vTypeEvaluation AS SELECT Id,Titre,DateLimite,Description,Objectif,CONCAT(Titre,DateLimite,Description,Objectif) AS tag FROM tblTypeEvaluation;
